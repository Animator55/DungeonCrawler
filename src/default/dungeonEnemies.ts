...
export const dungeonEnemies: router = {
    ...
    "Bestias": {
        ...
        Boss: {
            E: { name: "Avestruz de Guerra", description: "Un ave veloz y fuerte, utilizada por algunos guerreros para el combate." },
            D: { name: "Escarabajo de Fuego", description: "Un insecto que puede generar fuego desde su abdomen para quemar a sus enemigos." },
            C: { name: "Mantícora", description: "Una mantícora completamente desarrollada con habilidades mortales en vuelo y combate cuerpo a cuerpo." },
            B: { name: "Leviatán", description: "Una bestia marina colosal que habita en los océanos profundos, capaz de destruir barcos enteros." },
            A: { name: "Mono Furioso", description: "Un primate agresivo y territorial, capaz de utilizar herramientas rudimentarias en combate." },
            S: { name: "Tortuga del Tiempo", description: "Una tortuga que controla el flujo del tiempo, puede acelerar o retroceder momentos a su antojo." },
        }
    },
    "Elementales": {
        E: [
